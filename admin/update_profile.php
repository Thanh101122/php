...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="name" value="<?= $fetch_profile['name']; ?>" required placeholder="nhập tên người dùng của bạn" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
